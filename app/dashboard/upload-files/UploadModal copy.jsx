...
export default function UploadModal({
  ...
  const getUserData = () => {
    return userFileLogs.data || { uploadedFiles: {} };
  };

  console.log(userFileLogs.data);
  ...
  useEffect(() => {
    ...
    const files = Object.entries(userFileLogs.data.uploadedFiles || {}).filter(
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      //   const fileId = setSelectedFileData._id;
      ...
      if (uploadMode === "merge") {
        ...
        handleSelect(updatedFile);
        setUserTransaction(updatedFile.transactions);
        console.log("file id: ", selectedFile._id);
        ...
        console.log("Merge update response:", response.data);
      } else {
        // Create new file
              ...
              {uploadMode === "merge" && (
                <div className="mt-3">
                  ...
                  >
                    ...
                    {/* <SelectContent>
                      {userFileLogs.data.map(([key, file]) => (
